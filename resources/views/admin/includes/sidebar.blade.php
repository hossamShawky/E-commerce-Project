...
{{--                        {{\App\Models\Language::active()->count()}}--}}
       ...
       <li><a class="menu-item" href="{{route('admin.languages.switch','en')}}" data-i18n="nav.dash.crypto">
                               تغير اللغه الي الانجليزيه أو العربيه </a>
                    </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    ...
                    <span
                        ...
                        {{\App\Models\MainCategory::where('translate_of',0)->count()}}

                    </span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.maincategories')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض كل الأقسام الرئيسيه </a>
                    </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">الأقسام الفرعيه </span>
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">
                        {{\App\Models\SubCategory::where('translate_of',0)->count()}}

                    </span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.subcategories')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض كل الأقسام الفرعيه </a>
                    </li>
